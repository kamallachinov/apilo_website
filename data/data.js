...
export const menuData = {
  logoLight: '/images/optima.svg',
  logoDark: '/images/optima.svg',
...
export const FooterData = {
  logo: '/images/optima.svg',
  logoDark: '/images/optima.svg',
  footerText: 'Hər növ Charge Həlləri üçün Yerli İstehsal Olan, Vahid Elektron Platforma',
  copyright: `${new Date().getFullYear()} Asan Charge. All Rights Reserved`,
  email: 'info@asancharge.az',
  phone: '+994 51 521 5376',
  expolre: [
    {
      id: 1,
      name: 'Haqqımızda',
