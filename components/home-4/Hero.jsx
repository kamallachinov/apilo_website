...
const Hero = () => {
  return (
    <section
      ...
      id="scene">
      <div className="to{-48.41%} absolute left-0 top-0 h-full max-h-[400px] w-full bg-[linear-gradient(180deg,var(--tw-gradient-stops))] from-[#86489C] from-[-2.27%] to-[#86489C]/0 dark:hidden"></div>
