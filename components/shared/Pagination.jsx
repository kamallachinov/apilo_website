      ...
      <ul className="flex items-center justify-center gap-2">
        ...
        {Array.from({ length: totalPage }, (_, index) => (
          <li className={`group ${index + 1 === currentPage && 'page-active'}`} key={index}>
            <button
              href=""
              className="flex h-10 w-10 items-center justify-center rounded-full text-sm font-medium duration-300 hover:bg-fuchsia-700  hover:text-paragraph group-[.page-active]:bg-fuchsia-600 dark:group-[.page-active]:text-paragraph"
