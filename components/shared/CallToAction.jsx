    ...
    <section className="relative pb-20 pt-150 max-md:overflow-hidden max-md:pb-25 max-md:pt-25">
      <div className="container relative ">
        ...
        <div className=" mx-auto text-center">
          ...
          <p className="mx-auto mb-12 max-w-[400px] max-lg:mt-6">{t('callToAction.description')}</p>
          <Link href="/contact" className="btn">
            {t('callToAction.getStartedButton')}
          </Link>
          <ul className="mx-auto mt-20 flex  max-w-[815px] items-center justify-between max-lg:mt-5 max-lg:flex-col max-lg:gap-5">
            <li className="flex items-center">
              ...
              <p> {t('callToAction.noCreditCardRequired')}</p>
            </li>
            <li className="flex items-center">
              <svg
                width="20"
            ...
            <li className="flex items-center">
              ...
              <p>{t('callToAction.moneyBackGuarantee')}</p>
            </li>
          </ul>
        </div>
      </div>
