    ...
    <section className="relative pb-25 max-md:overflow-hidden max-md:pb-25">
      <div className="container relative max-md:text-center">
        <div className="absolute -bottom-[442px] left-1/2 -z-10  flex -translate-x-1/2 max-md:hidden max-md:flex-col">
          <div className="rounded-full bg-fuchsia-700/20 blur-[145px]  max-1xl:h-[335px] max-1xl:w-[335px]  max-md:hidden 1xl:h-[442px] 1xl:w-[442px]"></div>
        ...
        <div>
          <div>
            <p className="section-tagline">İlk Addımı Atın</p>
          </div>
          <div className="grid-y-10 grid grid-cols-12 items-start">
            <div className="max-md:col-span-full md:col-span-6 lg:col-span-7">
              <h2 className="mb-5 text-[48px] font-semibold max-lg:text-[32px]">Xəbərlər axışına yazılın</h2>
              <p>Platformamızla bağlı yeniliklərdən ilk siz xəbərdar olun</p>
            </div>
              ...
              <form>
                <div className="grid grid-cols-12 items-center max-lg:gap-y-5 lg:gap-x-6 ">
                  <input
                    ...
                    className="placeholder:text-light text-light h-full rounded-[60px] border border-borderColor  bg-transparent bg-white ps-5 leading-[1.75] text-[#A1A49D] outline-none transition-all duration-300 focus:border-fuchsia-700 focus:outline-none dark:border-[#31332F] dark:bg-dark-200 dark:placeholder:text-[#A1A49D] dark:focus:border-fuchsia-700 max-lg:col-span-full max-lg:py-3.5 lg:col-span-8"
                  />
                  <button className="btn max-lg:col-span-full lg:col-span-4">Yazılmaq</button>
                </div>
              </form>
                ...
                <li className="flex items-center">
                  <svg
                    ...
                    <path
                      ...
                      stroke=""
                      className="stroke-paragraph dark:stroke-fuchsia-700"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                  </svg>
                  <p>Şarj Stansiya Sahibləri</p>
                </li>
                <li className="flex items-center">
                  <svg
                    width="20"
                  ...
                  <p>Elektrikli Nəqliyyat Vasitəsi Sahibləri</p>
                </li>
              </ul>
            </div>
          </div>
