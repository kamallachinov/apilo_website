              ...
              <FadeUpOneByOneAnimation
                ...
                <div className="dark:border-borderColour-dark rounded border border-dashed border-gray-100 p-8 max-md:p-4">
                  <div className="flex gap-10 max-lg:gap-5">
                    <div className="after:border-borderColour-dark relative flex size-10 shrink-0 items-center justify-center rounded-full bg-fuchsia-700 after:absolute after:left-1/2 after:top-1/2 after:size-[30px] after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:border after:border-dashed">
                      <p className="font-jakarta_sans font-bold text-slate-50 dark:text-slate-50">{plan.id}</p>
                    </div>
                    <div>
