        ...
        <div className="rounded border border-dashed border-gray-100 bg-white px-8 py-12 dark:border-borderColor-dark dark:bg-dark-200 max-md:px-4">
          <div className="mb-12">
            ...
            <label className="relative block">
              ...
              <input
                className="w-full rounded-[60px] border border-borderColor py-5 pl-12 pr-5 font-jakarta_sans transition-all duration-300 placeholder:font-jakarta_sans placeholder:text-paragraph-light focus:border-fuchsia-700 focus:outline-none dark:border-borderColor-dark dark:bg-transparent dark:text-paragraph-light dark:focus:border-fuchsia-700 "
                placeholder="Search..."
                type="text"
                value={search}
          ...
          <div className="mb-12">
            <h3 className="mb-3">Kateqoriyalar</h3>
          ...
          <div className="mb-12">
            <h3 className="mb-8">Son Aktivlik</h3>
          ...
          <div>
            <h3 className="mb-8">Taglar</h3>
            <div className="flex w-full flex-wrap gap-3 ">
              {uniqueTags.map((item) => (
                <div key={item.data.tags} className={`${setActive == item.data.tags ? 'tagActive group' : ''}`}>
                  <Link
                    href={`/tags/${item.data.tags}`}
                    className="btn-outline btn-sm group-[.tagActive]:bg-[#A21CAF] group-[.tagActive]:text-white dark:group-[.tagActive]:bg-[#A21CAF] dark:group-[.tagActive]:text-[#fff]">
                    {item.data.tags}
                  </Link>
                </div>
              ))}
