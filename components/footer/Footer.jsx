      ...
      <div className="container">
        <div className="mb-20 grid grid-cols-12 max-lg:gap-y-10 max-lg:text-center">
          ...
          <div className="col-span-12 max-lg:text-center lg:col-span-2">
            <h3 className="mb-8 text-lg font-medium">Kəşf Et</h3>
          ...
          <div className="col-span-12 max-lg:text-center lg:col-span-2">
            <h3 className="mb-8 text-lg font-medium">Məlumatlar</h3>
            <ul className="[&>*:not(:last-child)]:mb-3">
          ...
          <div className="col-span-12 max-lg:text-center lg:col-span-2">
            <h3 className="mb-8 text-lg font-medium">Əlaqə Saxlayın</h3>
            <p className="mb-3">Kömək Lazımdır?</p>
            <p className="mb-3">
              <Link
