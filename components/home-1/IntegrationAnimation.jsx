...
const IntegrationAnimation = () => {
  ...
  //changed text-primaty to fuchsia-700
      ...
      <div className="relative -z-10 mx-auto -mt-15 max-w-[1068px] max-md:hidden">
        <div className="relative z-10 w-full py-[175px] max-xl:py-150 max-lg:py-25">
          <div className="align-center relative mx-auto flex h-150 w-150 flex-row justify-center rounded-full bg-white shadow-nav dark:bg-dark-200">
            <div className="align-center absolute left-1/2 top-1/2 mx-auto flex h-[122px] w-[122px] -translate-x-1/2 -translate-y-1/2  flex-row justify-center rounded-full bg-fuchsia-100 dark:bg-[#2B2D2A]">
              <span className="inline-block px-[25px] py-[46px] text-[30px] font-semibold leading-none text-fuchsia-700">
                OCPP
              </span>
            </div>
          </div>
              ...
              <svg
                ...
                <g id="rect" data-svg-origin="25.5 25.5" transform="matrix(1,0,0,1,255.40852,119.431)">
                  <g filter="url(#filter0_f_283_246)">
                    <circle cx="25.5" cy="25.5" r="7.5" fill="" className="fill-fuchsia-700"></circle>
                  </g>
                  <g filter="url(#filter1_f_283_246)">
                    <circle cx="25.5" cy="25.5" r="5.5" fill="" className="fill-fuchsia-700"></circle>
                  </g>
                </g>
                <defs>
                  <filter
